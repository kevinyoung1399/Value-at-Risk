...
/**
 * The BlackScholesMertonOptionPricing component of this React App
 * @author Kevin Young
 */
class BlackScholesMertonOptionPricing extends React.Component {
...
/**
  ...
  onCalculate = () => {
    ...
    fetch('http://localhost:5000/blackscholesmertonoptionpricing', {
      method: 'post',
    ...
    return (
          <div className="measure br3 ba b--col1 mv4 mw2 center w-80-l">
            ...
            <legend className="f1 fw6 ph0 mh0">value at risk finder</legend>
              <legend className=" f2 fw6 ph0 mh0 center ">the black scholes merton model.</legend>
...
export default BlackScholesMertonOptionPricing;