...
/**
 * The BinomialOptionPricing component of this React App
 * @author Kevin Young
 */
class BinomialOptionPricing extends React.Component {
...
/**
  ...
  onCalculate = () => {
    ...
    fetch('http://localhost:5000/binomialoptionpricing', {
      method: 'post',
      ...
      body: JSON.stringify({
        ...
        timePerStep : this.state.timePerStep, 
    ...
    return (
          <div className="measure br3 ba b--col1 mv4 mw2 center w-80-l">
            ...
            <legend className="f1 fw6 ph0 mh0">value at risk finder</legend>
              <legend className=" f2 fw6 ph0 mh0 center ">the binomial option pricing model.</legend>
                  ...
                  <div className="mt3">
                    <label className=" db fw6 lh-copy f6">dividend yield</label>
                    <input
                      className="pa2 input-reset white ba b--light-gray ba bg-transparent border-white hover w-40-m w-40-l"
                      type="number"
                      min="0"
                 ...
                 <div className="mt3">
                    <label className=" db fw6 lh-copy f6">time per step in tree (years)</label>
                    <input
                      className="pa2 input-reset white ba b--light-gray ba bg-transparent border-white hover w-40-m w-40-l"
                      type="number"
                      min="0"
                  ...
                  <div className="mt3">
                    <label className=" db fw6 lh-copy f6">number of steps in tree</label>
                    <input
                      className="pa2 input-reset white ba b--light-gray ba bg-transparent border-white hover w-40-m w-40-l"
                      type="number"
                      min="1"
...
export default BinomialOptionPricing