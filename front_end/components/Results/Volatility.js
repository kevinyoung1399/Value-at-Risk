...
/**
 * The Volatility component of this React App
 * @author Kevin Young
 */
const Volatility = ({volatility, onRouteChange}) => {
	...
	return (
			...
			<main className="ba b--transparent ph0 mh0 mv3">
				<div className='green pa2 f3 fw6 ph0 mh0'>
				 	<label className="db fw6 lh-copy f4" htmlFor="text">the volatility of your stock is estimated as:</label>
